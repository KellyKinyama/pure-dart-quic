// XoQ chat server example — application code that lives ABOVE the
// pure_dart_quic transport layer. The WebTransport / QUIC plumbing is
// imported as an opaque library; nothing chat-specific lives in
// `bin/server.dart` or in `lib/src/`.
//
// Wire protocol (matches the bundled `app.js` browser client):
